...
# Date : <09-09-2035>
# Lecture: <1> <Itroduction to machine learning>
# Dependencies: SciKit-Learn
# Python version:3.12
# Functionality: ceate a plot for a polynomial curve depending on degrees, and a plot with regulation, and a plot with 100 data points.
# ###################################
# %%
import os
import numpy as np
